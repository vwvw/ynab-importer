...
use App\Ynab\Object\TransactionGroup;
use Countable;
 ...
 */
class GetTransactionsResponse extends Response implements Countable, Iterator
{
    /** @var Collection */
    private $collection;
    /** @var int */
    ...
    public function __construct(array $data)
    {
        ...
        foreach ($transactions as $array) {
            $model = TransactionGroup::fromArray($array);
